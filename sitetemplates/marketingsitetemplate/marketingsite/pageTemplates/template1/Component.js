...
/*global jQuery, sap */
jQuery.sap.declare("cpv2.templates.template1.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.Router");

// new Component
sap.ui.core.UIComponent.extend("cpv2.templates.template1.Component", {
	...
	createContent: function() {
		...
		this.oMainView = sap.ui.view({
			...
			viewName: "cpv2.templates.template1.Template1",
